...
We can see that one of the most popular entries under 'project\_id' is 'TCGA-BRCA', giving 1098 cases as of July 2019. We will focus on this dataset going forward.
...
We start by figuring out what the 'sample\_id' might be called in GDC. We *g**r**e**p*() for 'case':
