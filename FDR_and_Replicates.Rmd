...
## Scatter Plot
Let's get an idea of within-group noise by taking the 2 healthy breast samples
...
I'll need to look at a larger number of genes.
I ran the script findCols.py to identify which Hardy=0 women 40-49 with healthy
breast tissues were also in the Wang dataset.
That gave me a file called gtex0_cols.txt.  From there, I subsetted the Wang breastrsemfpkmgtex.txt
dataset.

From the output gtex0_cols.txt, I created the subsetting Wang file:
$ cut -f1,2,3,4,19,26,34,35,39,57,58,60,62,63,64,65,69,77,78,82,86 breastrsemfpkmgtex.txt > breastRSEMFPKM_Hardy0.txt
